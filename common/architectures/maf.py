...
class AE(torch.nn.Module):
    ...
    def forward(self, x, y=None):
        # print(x.shape)
        x = F.relu(self.enc1_bn(self.enc1(x, y)))
        x = F.relu(self.enc2_bn(self.enc2(x, y)))
        x = F.relu(self.enc3_bn(self.enc3(x, y)))
        x = F.relu(self.enc4_bn(self.enc4(x, y)))
        x = F.relu(self.enc5_bn(self.enc5(x, y)))

        x = F.relu(self.dec1_bn(self.dec1(x, y)))
        x = F.relu(self.dec2_bn(self.dec2(x, y)))
        x = F.relu(self.dec3_bn(self.dec3(x, y)))
        x = F.relu(self.dec4_bn(self.dec4(x, y)))
        x = F.relu(self.dec5_bn(self.dec5(x, y)))
